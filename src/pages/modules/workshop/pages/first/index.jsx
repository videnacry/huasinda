...
const Index = () => {
    ...
    return(
        <div className="first">
            <ol>
                <h1>Replanteo magnético y cardinal</h1>
                <li>
                    <h2>Determinación de líneas Harmann:</h2> 
                    <p>
                        Las líneas Harmann son líneas imaginarias que se considera que 
                        recorren la superficie de la Tierra, conectando puntos con igual intensidad de campo magnético. En la 
                        ...
                        habitables en áreas donde las líneas Harmann sean más intensas.
                    </p>
                    <p>
                        La determinación de líneas Harmann se refiere a un<div className='space-tablet'/> estudio o análisis realizado para identificar y mapear 
                    ...
                    <p>
                        ...
                        que fluyen en la Tierra y forman una red o malla. Estas corrientes pueden estar influenciadas por 
                        diferentes factores, como la presencia de fallas geológicas, corrientes subterráneas, minerales en el 
                        suelo, entre otros. La determinación de líneas Harmann<div className='space-tablet'/> implica realizar mediciones y análisis utilizando 
                        dispositivos de detección electromagnética especializados. Estos dispositivos pueden incluir brújulas 
                        sensibles a campos electromagnéticos, medidores de radiación electromagnética, o incluso dispositivos 
                        más avanzados como magnetómetros.
                    </p>
                    <p>
                        El análisis de la presencia y la dirección de las líneas Harmann en un área determinada, ya sea en el 
                        terreno donde se realizará la construcción o en el lugar donde se encuentra una estructura existente, 
                        ...
                        descanso o áreas de trabajo, evitando la exposición prolongada a las líneas de radiación.<div className='space-tablet'/>
                        ...
                        científica convencional. Por lo tanto, su aplicación y consideración en la bioconstrucción puede variar 
                ...
                <li>
                    ...
                    <p>
                        ...
                        recorren la superficie de la Tierra y están relacionadas con la propagación de corrientes eléctricas<div className='space-tablet'/> y 
                        electromagnéticas en la tierra. Estas líneas son utilizadas en la geomancia y se cree que pueden tener 
                        ...
                        de áreas de descanso, como camas o espacios de meditación, en áreas donde las líneas<div className='space-pc'/> Curry sean más 
                        prominentes.
                    </p>
                    <p>
                        La determinación de líneas Curry se refiere a un estudio o análisis que se realiza para identificar y 
                        mapear las líneas de radiación geopatógena propuestas por el investigador alemán Manfred Curry. Estas 
                        líneas<div className='space-tablet'/> también se conocen como "líneas de rejilla Curry" o "rejilla de Curry". Según la teoría de Curry, la 
                        Tierra está atravesada por una red de líneas de energía geopatógena que se extienden en dirección
                        noreste-suroeste y noroeste-sureste. Estas líneas se generan debido a la interacción entre los campos 
                    ...
                    <p>
                        ...
                        la ubicación<div className='space-tablet'/> y dirección de las líneas de rejilla Curry, de manera similar a la<div className='space-pc'/> determinación de las líneas 
                        Harmann. Puede ser considerada al planificar y diseñar una estructura, especialmente en áreas donde se 
                        busca maximizar la salud y el bienestar de los ocupantes. Algunas personas creen que evitar la 
                ...
                <li>
                    <h2> Determinación de chimeneas y venas telúricas:</h2> 
                    <p>
                        En el contexto de la geomancia y las energías sutiles 
                        de la Tierra, se cree que existen chimeneas y venas telúricas, que son corrientes<div className='space-tablet'/> de energía natural que 
                        fluyen a través del subsuelo. Se dice que estas corrientes pueden afectar el bienestar humano y la 
                        calidad de los espacios habitados. 
                    </p>
                    <p>
                        Las chimeneas y venas telúricas son consideradas fenómenos naturales que se cree que tienen un 
                        ...
                        medición de campos<div className='space-pc'/><div className='space-tablet'/> electromagnéticos. Estas herramientas se utilizan para detectar las corrientes 
                        energéticas y trazar su ubicación y dirección en un área determinada.
                    </p>
                    <p>
                        En la bioconstrucción, se cree que la presencia de chimeneas y venas telúricas puede tener efectos 
                        negativos para la salud y el bienestar de las personas. Por lo tanto, se busca evitar la ubicación de áreas 
                        sensibles, como dormitorios o áreas de descanso, sobre estas corrientes. En algunos casos, se pueden 
                        tomar medidas para redirigir o mitigar los efectos de estas corrientes mediante técnicas como la 
                        colocación de materiales adecuados en el suelo.
                    </p>
                    <p>
                        Es importante tener en cuenta que la orientación magnética estructural en la<div className='space-tablet'/> bioconstrucción se basa en 
                        enfoques y creencias alternativas, y no cuenta con un amplio respaldo científico en la comunidad 
                ...
                <li>
                    <h2>Orientación magnética estructural:</h2> 
                    <p>
                    ...
                    <p>
                        La orientación magnética estructural se refiere a la<div className='space-tablet'/> elección y alineación de una estructura o edificio de 
                        acuerdo con la dirección del campo magnético terrestre. Se cree que la orientación adecuada de una 
                        construcción en relación con el campo magnético puede tener beneficios para la salud y el bienestar de 
                        ...
                        entre los ocupantes y su entorno.
                    </p><div className='space-pc'/>
                    <p>
                        Se cree que la orientación magnética adecuada puede mejorar la calidad del sueño,<div className='space-tablet'/> promover un mayor 
                        bienestar y reducir el estrés en los ocupantes. Además, se considera que una buena orientación 
                        magnética puede mejorar la eficiencia energética y el rendimiento general de la estructura.
                    </p>
                </li>
            </ol>
        </div>
